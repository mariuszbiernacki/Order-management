...
import {
  removeDeletedOrder as removeDeletedOrderAction,
  openProductModal as openProductModalAction,
  openBillModal as openBillModalAction,
  selectDoneOrder as selectDoneOrderAction,
    ...
    >
      ...
      {numSelected > 0 ? (
        <Tooltip title="Delete">
          <IconButton
            aria-label="delete"
            onClick={() => props.removeDeletedOrder(props.selected)}
          >
            <DeleteIcon />
          </IconButton>
        </Tooltip>
    ...
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar
          ...
          selected={selected}
          removeDeletedOrder={removeDeletedOrder}
        />
        <TableContainer>
          <Table
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">
                        <Tooltip title="Zobacz produkty">
                          <IconButton
                            aria-label="showProducts"
                            onClick={() => {
                              selectDoneOrder(row.orderId);
                              openProductModal();
                            }}
                          >
                            <VisibilityIcon />
...
const mapDispatchToProps = (dispatch) => {
  return {
    removeDeletedOrder: (orderId) =>
      dispatch(removeDeletedOrderAction(orderId)),
    ...
    selectDoneOrder: (orderId) => dispatch(selectDoneOrderAction(orderId)),
    openEditProductModal: () => dispatch(openEditProductModalAction()),
    openEditBillModal: () => dispatch(openEditBillModalAction()),
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(DoneOrdersTable);
