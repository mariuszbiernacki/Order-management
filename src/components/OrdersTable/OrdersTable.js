...
const headCells = [
  ...
  },
  {
    ...
    numeric: false,
    disablePadding: false,
    label: "dodawanie rachunków",
  },
  {
    id: "finishOrder",
    numeric: false,
    disablePadding: false,
    label: "koniec zamówienia",
  },
];
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">
                        <Tooltip title="Edytuj zamówienie">
                          <IconButton
                      ...
                      <TableCell align="right">
                        <Tooltip title="przenieś do skończonych zamówień">
                          <IconButton
